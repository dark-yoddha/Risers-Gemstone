...
public class HealingGemListener implements Listener {
    ...
    public void onRightClick(PlayerInteractEvent event) {
        ...
        player.addPotionEffect(new PotionEffect(PotionEffectType.HEALTH_BOOST, (int)(buffDurationMillis / 50), 1, true, false, true)); // +4 hearts
    ...
    private boolean isHealingGem(ItemStack item) {
        return item != null && item.getType() == Material.PINK_DYE && item.hasItemMeta() &&
                item.getItemMeta().getDisplayName().equals(String.valueOf(ChatColor.LIGHT_PURPLE) + "Healing Gem");
    }
}