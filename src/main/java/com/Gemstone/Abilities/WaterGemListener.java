...
public class WaterGemListener implements Listener {
    ...
    public void onPlayerDealDamageInNether(EntityDamageByEntityEvent event) {
        ...
        double reducedDamage = originalDamage / 1.5;
    ...
    private boolean isWaterGem(ItemStack item) {
        return item != null && item.getType() == Material.TRIDENT && item.hasItemMeta() &&
                item.getItemMeta().getDisplayName().equals(String.valueOf(ChatColor.BLUE) + "Water Gem");
    }
